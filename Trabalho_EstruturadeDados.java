...
public class Trabalho_EstruturadeDados {
    ...
    public static void Insercao( int[] vetor){ 
           ...
           for(int i = 1; i < vetor.length; i++){
               ...
               //Imprimindo o vetor ordenado pelo metodo Inserção.
               String msg = "";
                   for (int i = 0; i < vetor.length; i++) {
                        msg += vetor[i];
                   if(i < vetor.length-1)
                ...
                JOptionPane.showMessageDialog(null,
                                        "Vetor ordenado pelo método (Inserção): "+msg);
    ...
    public static void Bolha(int [] vetor){
            ...
            for(int i = 0; i < vetor.length - 1; i++){
               ...
               //Imprimindo o vetor ordenado pelo metodo Bolha.
               String msg = "";
                   for (int i = 0; i < vetor.length; i++) {
                        msg += vetor[i];
                   if(i < vetor.length-1)
                   ...
                   JOptionPane.showMessageDialog(null,
                                        "Vetor ordenado pelo método (Bolha): "+msg);
    } 
    ...
    public static void Selecao(int [] vetor){
            ...
            //Imprimindo o vetor ordenado por Seleção
            String retorno = "Vetor ordenado pelo método (Seleção): ";
            for(int i = 0; i < vetor.length; i++){
                retorno += vetor[i];
                if(i < vetor.length - 1){
                retorno += " - ";   
